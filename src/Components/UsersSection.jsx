...
const users = [
  {
    ...
    info: "هنـرجـوی دوره ویدئویی درآمد دلاری",
  },
  {
    image: user2,
    name: "احمد حسین زاده",
    description:
      "واقعـاا از دوره خیلـی رضایـت دارم ، پشتیبـانی عـالی ، کیفیـت واقعـا عـالی ، نکتـه هـای آمـوزشی خیلـی ریز ، مهم و کاربردی داره ، همینطـور تمریـن هــا که باعث به چــالش کـشیده شدن من شـد باعثـ رشد و پیشرفـتــ من شد ، و مهمتریـن نکتــه بررسی تمرینات ، ارائه فیدبک و راهنمایی کـارفرمـا باعث شده ایـن دوره واقعـاا بی نظیـر بـاشـهـ خیلی ممنونـم بابـت آمـوزش خیلـی خــوبتــونـ نکـات خیلـی ریـزی یــاد گـرفتــم.",
    info: "هنـرجـوی دوره جامع فروش محصول دیجیتال",
  },
  {
    image: user3,
    name: "مهدی جعفری",
    description:
      "واقعـاا از دوره خیلـی رضایـت دارم ، پشتیبـانی عـالی ، کیفیـت واقعـا عـالی ، نکتـه هـای آمـوزشی خیلـی ریز ، مهم و کاربردی داره ، همینطـور تمریـن هــا که باعث به چــالش کـشیده شدن من شـد باعثـ رشد و پیشرفـتــ من شد ، و مهمتریـن نکتــه بررسی تمرینات ، ارائه فیدبک و راهنمایی کـارفرمـا باعث شده ایـن دوره واقعـاا بی نظیـر بـاشـهـ خیلی ممنونـم بابـت آمـوزش خیلـی خــوبتــونـ نکـات خیلـی ریـزی یــاد گـرفتــم.",
    info: "هنـرجـوی دوره مبانی دیجیتال مارکتینگ برای بازارهای خارجی",
  },
  {
    image: user4,
    name: "سارا احمدی",
  ...
  },
  {
    ...
    description:
      "واقعـاا از دوره خیلـی رضایـت دارم ، پشتیبـانی عـالی ، کیفیـت واقعـا عـالی ، نکتـه هـای آمـوزشی خیلـی ریز ، مهم و کاربردی داره ، همینطـور تمریـن هــا که باعث به چــالش کـشیده شدن من شـد باعثـ رشد و پیشرفـتــ من شد ، و مهمتریـن نکتــه بررسی تمرینات ، ارائه فیدبک و راهنمایی کـارفرمـا باعث شده ایـن دوره واقعـاا بی نظیـر بـاشـهـ خیلی ممنونـم بابـت آمـوزش خیلـی خــوبتــونـ نکـات خیلـی ریـزی یــاد گـرفتــم.",
    info: "هنـرجـوی دوره آموزش کار با پلتفرم‌های همکاری از راه دور",
  },
  {
    image: user6,
    name: "نرگس فراهانی",
    description:
      "واقعـاا از دوره خیلـی رضایـت دارم ، پشتیبـانی عـالی ، کیفیـت واقعـا عـالی ، نکتـه هـای آمـوزشی خیلـی ریز ، مهم و کاربردی داره ، همینطـور تمریـن هــا که باعث به چــالش کـشیده شدن من شـد باعثـ رشد و پیشرفـتــ من شد ، و مهمتریـن نکتــه بررسی تمرینات ، ارائه فیدبک و راهنمایی کـارفرمـا باعث شده ایـن دوره واقعـاا بی نظیـر بـاشـهـ خیلی ممنونـم بابـت آمـوزش خیلـی خــوبتــونـ نکـات خیلـی ریـزی یــاد گـرفتــم.",
    info: "هنـرجـوی دوره کسب درآمد دلاری با فریلنسری بین‌المللی",
  },
];
